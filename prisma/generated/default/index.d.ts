...
export namespace Prisma {
  ...
  */
  ...
  export type TenantOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"name" | "dbUrl", ExtArgs["result"]["tenant"]>
  ...
  export interface TenantDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, ClientOptions = {}> {
     ...
     * const tenantWithNameOnly = await prisma.tenant.findMany({ select: { name: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Tenants and only return the `name`
     * const tenantWithNameOnly = await prisma.tenant.createManyAndReturn({
     *   select: { name: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * })
     * 
     * // Update zero or more Tenants and only return the `name`
     * const tenantWithNameOnly = await prisma.tenant.updateManyAndReturn({
     *   select: { name: true },
     *   where: {
     *     // ... provide filter here
     *   },
